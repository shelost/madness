...
Buttons.push(ResetButton, DoneButton, InfoButton, AffButton)
...
for (let i=0; i<Blocks.length; i++){
   ...
   // console.log(block.name &&  block.round > 0 && block.round < Brackets.length-1 && !Class('modal')[0].classList.contains('active'))
